...
//===========签名用到的参数==========
    ...
    unsigned char msg[20] = {"\x43\x68\x69\x6E\x65\x73\x65\x20\x49\x42\x53\x20\x73\x74\x61\x6E\x64\x61\x72\x64"};//Chinese IBS standard
//========加密用到的参数===================
    unsigned char cmsg[20] = {"\x43\x68\x69\x6E\x65\x73\x65\x20\x49\x42\x45\x20\x73\x74\x61\x6E\x64\x61\x72\x64"};//Chinese IBE standard
...
//==============密钥交换用到的参数================
    ...
    unsigned char bob[3] = {"\x42\x6F\x62"};//Bob
